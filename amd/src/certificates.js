...
/**
 * Certificates report JavaScript module for block_reports_custom.
 *
 * @module     block_reports_custom/certificates
...
define([
    ...
    /**
     * Certificates report controller.
     *
     * @class
     */
    var CertificatesReport = function() {
        this.form = null;
    ...
    /**
     * Initialize the certificates report.
     *
     ...
     */
    CertificatesReport.prototype.init = function(config) {
        var self = this;
     ...
     */
    CertificatesReport.prototype.setupEventListeners = function() {
        var self = this;
     ...
     */
    CertificatesReport.prototype.setupPaginationListeners = function() {
        var self = this;
     ...
     */
    CertificatesReport.prototype.updateReport = function() {
        var self = this;
     ...
     */
    CertificatesReport.prototype.updateReportContent = function(html) {
     ...
     */
    CertificatesReport.prototype.showLoading = function() {
        if (this.reportContainer) {
     ...
     */
    CertificatesReport.prototype.hideLoading = function() {
        if (this.reportContainer) {
     ...
     */
    CertificatesReport.prototype.showError = function(error) {
    ...
    return {
        /**
         * Initialize the certificates report module.
         *
         * @param {Object} config - Configuration object.
         */
        init: function(config) {
            var report = new CertificatesReport();
            report.init(config || {});
        }
    };
});
